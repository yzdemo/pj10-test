...
-Keep absences to a minimum, but we will keep absent members up to speed to the best of our ability
-We will do our best to succeed
-We will list the input and output values for functions and describe each of them to maintain readability
-If you need help, ask early on to resolve misunderstandings  
-We will be nice to each other and give each other a turn to speak :)
