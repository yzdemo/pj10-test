...
4. Lucy(Present): Get familiar with the frameworks 
5. Wilson(Present): Ran google calendar API, and figure out how to upload pdf. 
6. Matthew(Present): Learning obstacle: Ideas for action. 
